...
public class DesignController {
    ...
    @PostMapping("")
    public ResponseEntity<Design> createDesign(@Valid @RequestBody DesignRequest designRequest){
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Design> updateDesign(@Valid @PathVariable Long id, @RequestBody DesignRequest designRequest) {
